({
    ...
    fn_accReg : function (component) {
        this.gfn_createComponents(component, 'zzExmYRAccountRegQa', null, 'slds-modal_medium');
    },
    ...
    fn_multiSave : function (component) {
        this.gfn_createComponents(component, 'zzExmYRAccMultiEditQa', null, 'slds-modal_medium');
    },


    fn_newFile : function (component, event, helper) {
        this.gfn_createComponents(component, 'zzExmYRAccNewFileQa', null, 'slds-modal_medium');
    }
