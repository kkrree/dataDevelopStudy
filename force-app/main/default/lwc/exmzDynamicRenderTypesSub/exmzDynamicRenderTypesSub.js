/****************************************************************************************
 * @filename      : ExmzDynamicRenderTypesSub
 * @author        : I2MAX
 * @date          : 2021-03-15
 * @group         :
 * @group-content :
...
export default class ExmzDynamicRenderTypesSub extends LwcExmzBase {
//============================================================================
//============================================================================
...
//============================================================================
    ...
    gfnComInitDynamicComponent(renderData) {
        this.gfnLog('sub override gfnComDynamicRenderInit called...', renderData?.paramData);
        this.gfnLog('sub renderData.paramData', renderData?.paramData?.value, renderData?.isInit);
