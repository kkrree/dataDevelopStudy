 ...
 * ===============================================================
 0.1     2020-04-01 오전 7:52      I2MAX           Create
 ****************************************************************************************/
/**
 * =====================================================
 * 기본 import
...
import { LwcComService } from 'c/lwcComService';
import { LwcComPubSub } from 'c/lwcComPubSub';
import { LwcComData } from 'c/lwcComData';
import { LwcComUtil } from 'c/lwcComUtil';
import { LwcComNaviService } from "c/lwcComNaviService";
import { LwcComThirdPartyService } from "c/lwcComThirdPartyService";
...
export class LwcComBase extends NavigationMixin(LightningElement) {
    ...
    /**
     * 모든 pubsub의 event에 등록된 자신의(this) 모든 listener를 해제함
     * 따라서 업무에서는 disconnectedCallback에서 별도 해제할 필요가 없음
     * @override
     */
 ...
 * =============================================================================
 */
Object.assign(LwcComBase.prototype, LwcComService, LwcComNaviService, LwcComThirdPartyService, LwcComPubSub);
