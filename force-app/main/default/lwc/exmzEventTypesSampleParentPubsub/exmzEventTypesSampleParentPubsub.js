/****************************************************************************************
 * @filename      : ExmzEventTypesSampleParentPubsub
 * @author        : I2MAX
 * @date          : 2021-03-12
 * @group         :
 * @group-content :
...
export default class ExmzEventTypesSampleParentPubsub extends LwcExmzBase {
//============================================================================
//============================================================================
    ...
    connectedCallback() {
        this.gfnComConnectedCallback(() => {
            this.gfnPubSubRegisterListener('test_event_pubsub', (detail) => {
                this.gfnLog('Sample Parent PubSub detail', detail);
