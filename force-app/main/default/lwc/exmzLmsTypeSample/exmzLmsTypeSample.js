...
export default class ExmzLmsTypeSample extends LwcExmzBase {
//============================================================================
//============================================================================
...
//============================================================================
    publishMC() {
        publish(this.messageContext, TestChannel, {
            payload: this.publishMessage
        });
    }
    ...
    subscribeMC() {
        ...
        this.subscription = subscribe(this.messageContext, TestChannel, (message) => {
            console.log('Sample1 : ', message.payload);
            this.receivedMessage = message.payload;
        });
    }

    setPublishMessage(event) {
