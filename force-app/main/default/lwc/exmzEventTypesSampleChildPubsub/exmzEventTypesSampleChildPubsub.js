/****************************************************************************************
 * @filename      : ExmzEventTypesSampleChildPubsub
 * @author        : I2MAX
 * @date          : 2021-03-12
 * @group         :
 * @group-content :
...
export default class ExmzEventTypesSampleChildPubsub extends LwcExmzBase {
//============================================================================
//============================================================================
...
//============================================================================
    /**
     * fire event for pubsub
     * @param event
     */
    fireEventPubSub(event) {
        this.gfnPubSubFireEvent(this.gComPageRef, 'test_event_pubsub', {
            value: 'test_event_pubsub'
        });
    }
